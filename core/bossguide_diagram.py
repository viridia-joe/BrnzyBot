...
def _draw_hydross(W: int, H: int) -> "Image.Image":
    ...
    d.text((28, 30), "PHASE 1 — FROST FORM", fill=FROST_T, font=f_sm)

    # Pillars
    d.rectangle((52, 52, 68, frost_bot - 10), fill=(74, 112, 144))
    d.rectangle((W-68, 52, W-52, frost_bot - 10), fill=(74, 112, 144))
